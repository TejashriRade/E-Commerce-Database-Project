...
<Center><h1>View Stock</h1></center>
 ...
 <!--if edit button is pressed-->
                        ...
                        ResultSet rs=st.executeQuery("select model_no from laptop_system_info group by model_no");
                        while(rs.next())
                        {
                        ...
                        ResultSet rs3=st1.executeQuery("select count(*) from stock where model_no='"+modelno +"'");
                        if(rs3.next())
                        {
                        ...
                        ResultSet rs1=st3.executeQuery("select count(*) from stock where model_no='"+modelno +"' and order_id <>0");
                        if(rs1.next())
                        {
                        ...
                        ResultSet rs2=st4.executeQuery("select srno,order_id from stock where model_no='"+modelno +"'");
