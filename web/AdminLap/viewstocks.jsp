        ...
        <td><input type="submit" name="View" value="View Details" class="bttxt">
            ...
            <table width="400"> 
                       ...
                       if(request.getParameter("View")!=null)
                       {
                        ...
                        {
                        Statement st=con.createStatement();
                        ResultSet rs=st.executeQuery("select count(*) from stock where model_no='"+modelno +"'");
                        if(rs.next())
                        {
                        ...
                        ResultSet rs1=st.executeQuery("select count(*) from stock where model_no='"+modelno +"' and order_id <>0");
                        if(rs1.next())
                        {
                        ...
                        ResultSet rs2=st.executeQuery("select srno,order_id from stock where model_no='"+modelno +"'");
